...
import SignupBtn from '../containers/SignupBtnContainer';
        ...
        <header className="header">
          ...
          <div className="item-svg">
            <svg>
              ...
              <path
                className="st1"
                d="M173.2,296h-3.3v10.8h-1.4V296h-3.3v-1.3h8V296z"
              />
              <path
                className="st1"
                d="M181.1,306.8H175v-12.1h5.9v1.3h-4.5v4h4.2v1.3h-4.2v4.2h4.8V306.8z"
              />
              <path
                className="st1"
          ...
          <div className="form-contents">
            <form onSubmit={this.handleSubmit}>
              <fieldset className="form-contents__fieldset">
                ...
                />
                <label htmlFor="pwInput" className="label">
                  PASSWORD
                </label>
                <input
                  className="form-contents__fieldset-input"
                ...
                />
                <button className="button-g from-contents__login-button">
                  Login
                </button>
                <SignupBtn />
              </fieldset>
